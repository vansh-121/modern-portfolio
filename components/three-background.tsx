...
function ThreeBackgroundComponent() {
  ...
  const initializeScene = useCallback(() => {
    ...
    try {
      ...
      const material = new THREE.ShaderMaterial({
        ...
        vertexShader: `
          ...
          void main() {
            ...
            float orbitalAngle = time * orbitalSpeed * 2.0 + phase;
            ...
            float galaxyRotation = time * 0.25;
      ...
      for (let i = 0; i < shapeCount; i++) {
        ...
        const hue = (i / shapeCount) * 0.4 + 0.5
        ...
        shapeData.push({
          ...
          orbitalSpeed: (Math.random() - 0.5) * 0.03,
  ...
  useEffect(() => {
    ...
    const animate = (currentTime) => {
      ...
      particles.rotation.z = Math.cos(time * 0.4) * 0.12
