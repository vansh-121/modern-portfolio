  ...
  return (
    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl px-4 text-center z-0 pointer-events-none">
      <div className="mb-16 md:mb-20">
        {/* Main greeting with enhanced contrast and glow */}
          ...
          <h1
            ...
            style={{
              ...
              textShadow: isDark 
                ...
                : "0 0 30px rgba(255,255,255,0.9), 0 4px 20px rgba(102, 126, 234, 0.3), 0 8px 40px rgba(118, 75, 162, 0.2)",
            }}
          >
            <span className={`${
              isDark 
        ...
        <div className="space-y-3 mt-8">
          <p
            ...
            style={{
              ...
              textShadow: isDark 
                ...
                : "0 2px 15px rgba(255,255,255,0.9), 0 4px 30px rgba(102, 126, 234, 0.2)",
            }}
          >
            Full Stack Developer & UI/UX Designer
          </p>
          
          {/* Tech stack badges with enhanced visibility */}
          <div className="flex flex-wrap justify-center gap-2 mt-6 opacity-95">
            {["React", "Next.js", "Node.js", "TypeScript", "Python", "AWS"].map((tech, index) => (
              <span
                ...
                className={`px-3 py-1.5 text-xs md:text-sm rounded-full border font-medium ${
                  isDark 
                    ? "bg-gray-900/80 border-gray-600/60 text-gray-100 shadow-xl" 
                    : "bg-white/90 border-gray-400/60 text-gray-800 shadow-lg"
                ...
                style={{
                  ...
                  boxShadow: isDark
                    ...
                    : "0 4px 20px rgba(102, 126, 234, 0.3), 0 8px 40px rgba(118, 75, 162, 0.2)"
                }}
              >
                {tech}
              </span>
          ...
          {/* Call to action with enhanced glow */}
          <p
            ...
            style={{
              textShadow: isDark 
                ...
                : "0 2px 10px rgba(255,255,255,0.9), 0 4px 20px rgba(102, 126, 234, 0.2)",
            }}
          >
